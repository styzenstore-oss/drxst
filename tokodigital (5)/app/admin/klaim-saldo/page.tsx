  ...
  return (
    <div>
      <h1 className="mb-1 font-display text-2xl font-bold text-mist">
        Konfirmasi Pesanan Selesai &amp; Saldo
      </h1>
      <p className="mb-6 text-sm text-mist/60">
        Merchant menandai pesanan mereka sebagai selesai di sini. Klik
        &quot;Setujui&quot; setelah Anda mengecek dan pesanan memang benar sudah
        diproses/dikirim — pesanan otomatis berstatus &quot;Selesai&quot; dan saldo
        langsung ditambahkan ke dompet merchant. Klik &quot;Tolak&quot; jika belum
        sesuai; merchant bisa mengajukan ulang nanti.
      </p>
